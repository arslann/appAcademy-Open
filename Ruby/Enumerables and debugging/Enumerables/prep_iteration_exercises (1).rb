...
class Array
  ...
  def bubble_sort(&prc)
    new_arr = self.bubble_sort! &prc
    return new_arr.dup
  end
end
#p [2, 8, 5, 2, 6].bubble_sort { |num1, num2| num2 <=> num1 }
#p [10, 8, 7, 1, 2, 3].bubble_sort { |num1, num2| num2 <=> num1 }
...
def subwords(word, dictionary)
  words_arr = substrings(word)
  words_arr.select {|ele| dictionary.include?(ele)}
